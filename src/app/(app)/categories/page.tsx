  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-8">
      ...
      {editingCat && (() => {
        ...
        const editParentOptions = categories.filter(c =>
          c.type === editingCat.type && !c.parent_id && c.id !== editingCat.id
        )
        return (
              ...
              <form onSubmit={handleEditCategory} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-800 text-slate-200 rounded-md py-2 px-3 text-xs focus:border-emerald-500 outline-none transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <p className="mt-1 text-[9px] text-slate-500">
                    {hasChildren
                      ? 'Esta categoría tiene subcategorías, por eso no puede convertirse en subcategoría de otra.'
                      : 'Selecciona un padre para convertirla en subcategoría, o "Ninguna" para volverla principal.'}
                  </p>
                </div>
